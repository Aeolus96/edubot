...
def generate_launch_description() -> LaunchDescription:
    ...
    bringup_dir = get_package_share_directory("edubot")  # Our ROS2 package name
    launch_dir = os.path.join(bringup_dir, "launch")  # Launch files are in the launch directory of our package
    ...
    # Create our own temporary YAML files that include substitutions - launch parameters passed to node parameters
    yaml_substitutions = {
    ...
    declare_use_localization_cmd = DeclareLaunchArgument(
        "use_localization", default_value="True", description="Whether to enable localization or not"
    )

    declare_use_keepout_zones_cmd = DeclareLaunchArgument(
        "use_keepout_zones", default_value="True", description="Whether to enable keepout zones or not"
    )
